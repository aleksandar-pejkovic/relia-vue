    ...
    <div v-if="!isSmallScreen">
        <div class="table-responsive">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <tr v-for="customer in customers" :key="customer.id" @click="openEditCustomerModal(customer)" data-bs-toggle="modal" data-bs-target="#editCustomerModal">
                        <td>
                            {{ customer.name }}
                        </td>
                        <td>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-4 col-lg-3" v-for="customer in customers" :key="customer.id">
                    <div @click="openEditCustomerModal(customer)" data-bs-toggle="modal" data-bs-target="#editCustomerModal" class="card mt-2">
